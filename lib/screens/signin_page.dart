...
//           localizedReason:
//               'Veuillez scanner votre empreinte pour vous connecter',
...
//               SnackBar(
//                 content: Text(
//                   "Aucun token enregistré. Veuillez vous connecter manuellement.",
//                 ),
//               ),
//             );
//           }
//         } else {
//           ScaffoldMessenger.of(context).showSnackBar(
//             SnackBar(content: Text("Échec de l'authentification biométrique")),
//           );
//         }
//       } else {
//         ScaffoldMessenger.of(context).showSnackBar(
...
//                       MaxLengthValidator(
//                         15,
//                         errorText: 'maximum 15 caractères',
//                       ),
//                     ]),
//                   ),
//                   SizedBox(height: 20),
...
//                               password: _passwordController.text,
//                             );
//                             var result = await controller.signinController(
//                               user,
//                             );
//                             if (result['status'] == true) {
//                               var mytoken = result['token'];
...
//                                 MaterialPageRoute(
//                                   builder:
//                                       (context) => HomePage(token: mytoken),
//                                 ),
//                                 (Route<dynamic> route) => false,
//                               );
//                             } else {
